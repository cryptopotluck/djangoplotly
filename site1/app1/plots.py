...
from .data.binance_get_klines import create_coin_dataframe
...
def plot_LTC():
    table_trace1 = go.Table(
        ...
        cells=dict(
            values=[create_coin_dataframe().index[:], create_coin_dataframe()['open'], create_coin_dataframe()['high'],
                    create_coin_dataframe()['low'], create_coin_dataframe()['close'], create_coin_dataframe()['volume'],
                    create_coin_dataframe()['trade_number']],
